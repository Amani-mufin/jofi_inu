...
const Hero = () => {
  return (
    <section className="flex flex-col md:flex-row gap-10 md:gap-32 md:pl-40 pl-5 h-screen items-center w-full pt-20">
      <div className="order-2 md:order-1 w-full md:w-[385px] flex flex-col gap-5 text-center md:text-left">
      ...
      <div className="order-1 md:order-2 w-[300px] md:w-[681.19px] md:h-[696px] flex flex-col items-center ">
